...
class Venti_CriteriaModel extends BaseModel implements \Countable
{
    ...
    * @param BaseElementType $elementType
     ...
     */
    public function __construct($attributes, $elementType)
    {
        parent::__construct($attributes);

        $this->_elementType = $elementType;
        $this->setLanguage(craft()->locale->id);
    }
    ...
    protected function defineAttributes()
    {
        return array_merge(parent::defineAttributes(), array(
            ...
            'sort'          => array('default' => 'asc', AttributeType::String),
